...
#define BitsIoLdd1_PORT_MASK 0x40U     /*!< Mask of the allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x40 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 6U /*!< The index of the first allocated pin from the port */
